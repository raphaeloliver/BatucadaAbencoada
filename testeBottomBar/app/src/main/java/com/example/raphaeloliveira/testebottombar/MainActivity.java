...
import com.example.raphaeloliveira.testebottombar.fragments.MapsFragment;
        ...
        bottomBar.setOnTabSelectListener(new OnTabSelectListener() {
            ...
            public void onTabSelected(@IdRes int tabId) {
                ...
                if (tabId == R.id.tab_green) {
                    ActivityUtils.addFragmentToActivity(getSupportFragmentManager(), new MapsFragment(), R.id.contentFrame);
                }
